...
export const metadata: Metadata = {
  title: "Conspiracy Theory Reveal Party",
};
    ...
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .static-bg {
          ...
          z-index: 0;
          animation: staticshift 0.3s steps(1) infinite;
        }
        ...
        .corner-stamp {
          ...
          font-size: 9px;
          letter-spacing: 2px;
          color: rgba(26,20,8,0.2);
          text-transform: uppercase;
        }
        .corner-stamp.tl { top: 14px; left: 14px; }
        .corner-stamp.tr { top: 14px; right: 14px; text-align: right; }
        .corner-stamp.bl { bottom: 14px; left: 14px; }
        .corner-stamp.br { bottom: 14px; right: 14px; text-align: right; }
        ...
        @keyframes glitchwobble {
          ...
          94% {
            ...
            text-shadow: -3px 0 var(--red), 3px 0 #00f0ff;
            color: var(--ink);
          }
          96% { transform: skewX(2deg); text-shadow: 2px 0 var(--red); }
        ...
        .rsvp-block::before {
          content: 'RSVP / CONFIRM EXISTENCE';
          position: absolute;
          top: -8px; left: 10px;
          font-size: 7.5px;
          letter-spacing: 3px;
      ...
      <div className="conspiracy-page">
        ...
        <div className="invite">
          ...
          <div className="tape-top">
            <div className="tape-dot" />
            <span>FILE: SHEEP-001 &nbsp;|&nbsp; CLEARANCE: NONE &nbsp;|&nbsp; DISSEMINATION: REQUIRED</span>
            <div className="tape-dot" />
          </div>

          <div className="main-content">
            <div className="corner-stamp tl">DOC-22-▓▓▓▓<br />PAGE 1 OF 1</div>
            <div className="corner-stamp tr">EYES ONLY<br />OPEN IMMEDIATELY</div>
            <div className="corner-stamp bl">RETAIN / DO NOT DESTROY</div>
            <div className="corner-stamp br">ARRIVAL MANDATORY<br />NO EXCEPTIONS</div>

            <div className="eyeball-row">
              <div className="line-h" />
              <div className="eye">👁</div>
              <div className="eye" style={{ animationDelay: "0.8s" }}>👁</div>
              <div className="eye" style={{ animationDelay: "1.6s" }}>👁</div>
              <div className="line-h" />
            </div>
            ...
            <div className="theory-box">
              <p className="theory-text" style={{ marginBottom: "10px" }}>Your mission, should you choose to accept it:</p>
              <ul className="theory-text" style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            <div className="details-grid">
              <div className="detail-cell">
                ...
                <div className="detail-value">April 2nd</div>
                <div className="detail-sub">thursday. probably.</div>
              </div>
              <div className="detail-cell">
                <div className="detail-label">Time</div>
                <div className="detail-value">8:00 PM</div>
                <div className="detail-sub">if time is real</div>
              </div>
              <div className="detail-cell">
                <div className="detail-label">Location</div>
                <div className="detail-value">Upstate</div>
                <div className="detail-sub">coordinates withheld</div>
              </div>
            </div>
            ...
            <div className="warning-strip">
              ...
              <p>
                Do not tell <span>anyone</span> who isn&apos;t already here. &nbsp;|&nbsp;
                They are <span>listening</span>. &nbsp;|&nbsp;
                Bring snacks. The simulation gets hungry.
              </p>
            </div>
            ...
            <div className="rsvp-row">
              <div className="rsvp-block">
                <p className="rsvp-text">
                  Confirm your presence to the host.<br />
                  Or don&apos;t. We already know you&apos;re coming.<br />
                  <em>They told us.</em>
                </p>
              </div>
              <div className="stamp">
                <div className="stamp-text">WAKE</div>
                <div className="stamp-big">UP</div>
                <div className="stamp-text">2026</div>
              </div>
            </div>
          </div>
